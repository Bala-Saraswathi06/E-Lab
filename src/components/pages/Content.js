    ...
    return (
        <div>
            <div className='filter' style={{ position: 'relative', bottom: '80px' }}>
                ...
                <Row className='d-flex justify-content-center' >
                    <Button variant='danger' style={{ margin: '10px' }}> Botany Museum <i class="fa fa-angle-right" aria-hidden="true"></i> </Button>
                    <Button variant='danger' style={{ margin: '10px' }}> Zoology Museum <i class="fa fa-angle-right" aria-hidden="true"></i> </Button>
                </Row>
            </div>
            <Row style={{ margin: 'auto', width: "90%", }}>
                ...
                <Col lg='6'>
                    <Row className='d-flex justify-content-center' style={{ padding: '50px ' }}>
                        ...
                        <Button variant='danger'> View Museum <i class="fa fa-angle-right" aria-hidden="true"></i> </Button>
                    </Row>
                </Col>
            </Row>
            <Row style={{ margin: 'auto', width: "90%", }}>
